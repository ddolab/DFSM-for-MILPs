...
include("C:/scheduling_optimization_proxy_NN.jl") # trains a NN based optimization proxy, change destination to the folder with scheduling_optimization_proxy_NN or augmented_LD.jl
