...
include("C:/UMN/Research/ICML/codes and data/MPC/GNN_MPC_2.jl") # trains a NN based optimization proxy, change destination to the folder with MPC_optimization_proxy(2).jl
#=
E1=E1*Eo1[1]
Peng1=Peng1*Pmax
z1=z1*swi=#
